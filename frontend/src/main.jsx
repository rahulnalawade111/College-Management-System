      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin" element={<ProtectedRoute roles={['SUPER_ADMIN', 'ADMIN']}><DashboardLayout nav={ADMIN_NAV} /></ProtectedRoute>}>
            ...
            <Route path="students" element={<DashboardStub area="admin students" />} />
            <Route path="faculty" element={<DashboardStub area="admin faculty" />} />
            <Route path="departments" element={<DashboardStub area="admin departments" />} />
            <Route path="courses" element={<DashboardStub area="admin courses" />} />
          ...
          <Route path="/faculty" element={<ProtectedRoute roles={['FACULTY']}><DashboardLayout nav={FACULTY_NAV} /></ProtectedRoute>}>
            ...
            <Route path="attendance" element={<DashboardStub area="faculty attendance" />} />
          ...
          <Route path="/student" element={<ProtectedRoute roles={['STUDENT']}><DashboardLayout nav={STUDENT_NAV} /></ProtectedRoute>}>
            ...
            <Route path="attendance" element={<DashboardStub area="student attendance" />} />
          ...
          <Route path="/parent" element={<ProtectedRoute roles={['PARENT']}><DashboardLayout nav={PARENT_NAV} /></ProtectedRoute>}>
            ...
            <Route path="attendance" element={<DashboardStub area="parent attendance" />} />
